...
const Cotizacion = ({ resultado }) => {
    ...
    return (
        <div className="resultado cssanimation py-5">
            <h2>resultado</h2>
            ...
            <p>Variacion ultimas 24 horas: <span>{resultado.CHANGE24HOUR} %</span></p>
            <p>Ultima actualicazion: <span>{resultado.LASTUPDATE}</span></p>
        </div>
    )
}
